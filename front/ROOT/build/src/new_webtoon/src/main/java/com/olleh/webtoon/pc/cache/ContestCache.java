...
public class ContestCache {
	...
	protected static Log logger = LogFactory.getLog(ContestCache.class);
	private static ContestCache toonCache = null;       //MainCache 인스턴스
