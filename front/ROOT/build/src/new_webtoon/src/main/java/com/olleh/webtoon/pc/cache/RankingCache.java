...
public class RankingCache {
	...
	protected static Log logger = LogFactory.getLog(RankingCache.class);
	private static RankingCache rankingCache = null;       	//RankingCache.java 인스턴스
	...
	private static final long cacheTerm = 1000 * 60 * 60;	//캐시 유지 시간 - 1시간
     ...
     *
     * @return RankingCache rankingCache : RankingCache rankingCache
     */
