...
@Controller("MobileQNAController")
public class QNAController
{
	 ...
	 */
	@RequestMapping(value = "/m/support/qnaRegist.kt")
	public ModelAndView registQnaForm( HttpServletRequest req, HttpServletResponse res )
	{
		ModelAndView modelAndView = new ModelAndView();
		
		modelAndView.setViewName( "/mobile/support/qnaRegist" );
	 ...
	 */
	@RequestMapping( value = "/m/support/qnaRegistJsonProc.kt" )
	public ModelAndView registQnaProc( HttpServletRequest req )
	{
		...
		try
		{
			...
			qnaDomain.setPhone2( StringUtil.cleanXSS( RequestUtil.getParameter( req, "phone2", true ) ) );
