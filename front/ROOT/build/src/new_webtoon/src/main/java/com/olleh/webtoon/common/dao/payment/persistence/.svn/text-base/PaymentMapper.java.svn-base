 ...
 * DESCRIPTION    : 결제정보 DB 연동 관련 Mapper class.
 * 
 * VERSION NO     author           date        content  -> info
 * ----------------------------------------------------------------------------
      1.0        mslee      2014-06-02      init
 *****************************************************************************/
...
public interface PaymentMapper {
	 ...
	 */
	public void registPayment(PaymentDomain paymentDomain);
	 ...
	 * @param PaymentDomain paymentDomain : 결제정보
	 */
	public void modifyPayment(PaymentDomain paymentDomain);
	 ...
	 */
	public void registOrder(OrderDomain orderDomain);
	 ...
	 */
	public int getExcCtn(String ctn);
	
	
	/**
	 * 이용가능 상품 정보를 삭제한다.
	 *
	 * @param BuyDomain buyDomain : 주문내역
	 * @return void
	 */
	public void deletePrdAvail(BuyDomain buyDomain);
