...
@Controller
public class CommonBluemembershipController
{
	private Log							logger	= LogFactory.getLog( CommonBluemembershipController.class );
	 ...
	 * @throws Exception
	 */
	@RequestMapping( value = "/bluemembership/cancelChange.kt" )
	 ...
	 * @throws Exception
	 */
	@RequestMapping( value = "/bluemembership/reserveCancelJoin.kt" )
	 ...
	 * @throws Exception
	 */
	@RequestMapping( value = "/bluemembership/cancelCancelJoinReservation.kt" )
	 ...
	 * @return
	 */
	@RequestMapping( value = "/bluemembership/createOrder.kt" )
			...
			@RequestParam( value = "billmethodfg", required = true ) BillMethodCode billmethodfg ) throws Exception
	{
		...
		BMJoinDomain join = bmService.initJoinDataBeforePayment( prdcode, billmethodfg, buyertel, buyeremail );
	 ...
	 * @return
	 */
	@RequestMapping( value = "/bluemembership/createInicisIEParam.kt" )
	 ...
	 * @return
	 */
	@RequestMapping( value = "/testbill.kt" )
	 ...
	 * @throws Exception
	 */
	@RequestMapping( value = "/bluemembership/registerInicis.kt" )
			...
			@RequestParam( value = "isPopup", required = false ) Boolean isPopup) throws Exception
	{
		...
		if( join.getJoinstatusfg() != JoinStatusCode.wating )
		{
			...
			if( isMobile )
				mv.setViewName( "redirect:/m/mytoon/bluemembership/joinStatus.kt" );
			else
		...
		mv.setViewName( "redirect:/bluemembership/joinResult.kt?joinseq=" + join.getJoinseq() + "&paymentseq=" + paymentseq + "&isMobile=" + isMobile + "&isPopup=" + isPopup + "&isUserCancel=" + isUserCancel );
	 ...
	 * @throws Exception
	 */
	@RequestMapping( value = "/bluemembership/registerMobi.kt" )
			...
			@RequestParam( value = "isPopup", required = false ) Boolean isPopup) throws Exception
	{
		...
		mv.setViewName( "redirect:/bluemembership/joinResult.kt?" + "joinseq=" + join.getJoinseq() + "&paymentseq=" + paymentseq + "&isMobile="
	 ...
	 * @throws Exception
	 */
	@RequestMapping( value = "/bluemembership/joinResult.kt" )
			...
			@RequestParam( value = "isPopup", required = true, defaultValue = "false" ) boolean isPopup) throws Exception
	{
		...
		// 팝업이면 창을 닫고 부모창을 다시 common/bmJoinResultPopup.kt 컨트롤러로 이동시킴
		if( isPopup )
		{
			...
			mv.setViewName( "common/bmJoinResultPopup" );
			return mv;
		}
		...
		String viewPathPrefix = isMobile ? "mobile" : "pc";
		String urlPathPrefix = isMobile ? "/m" : "";
	...
	@RequestMapping( value = "/bluemembership/getBlueMembershipInfo.kt" )
	public ModelAndView getBlueMembershipInfo() throws Exception
	{
		...
		mv.addObject( "user", AuthUtil.getDecryptUserInfo( request ) );
	...
	@RequestMapping( value = "/bluemembership/getActiveJoin.kt" )
	...
	@RequestMapping( value = "/bluemembership/getReservedJoin.kt" )
