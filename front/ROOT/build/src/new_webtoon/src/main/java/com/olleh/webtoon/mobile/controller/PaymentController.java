...
public class PaymentController {
	 ...
	 */
	@RequestMapping(value = "/m/payment/payment.kt")
	public ModelAndView moveToPayment(HttpServletRequest request) {
		ModelAndView modelAndView = new ModelAndView();
		modelAndView.setViewName("mobile/payment/payment");
		...
		try {
			...
			// 2. 약관 동의 여부 체크
				...
				modelAndView.setViewName("redirect:/m/user/ollehUserAgreement.kt?urlcd=/m/payment/payment.kt");
				return modelAndView;
			...
			// 3. 본인 인증 여부 체크
				...
				if("ios".equals(RequestUtil.getClientDeviceInfo(request))){
					modelAndView.setViewName("redirect:/m/premium/ios_payment.kt");
					return modelAndView;
				}
				
				//modelAndView.setViewName("mobile/premium/premiumMyCert");
				modelAndView.setViewName("redirect:/m/premium/premiumMyCert.kt?urlcd=/m/payment/payment.kt");
				return modelAndView;
	...
	public ModelAndView moveToResult(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			// 2. 약관 동의 여부 체크
				...
				//modelAndView.setViewName("mobile/user/ollehUserAgreement");
				modelAndView.setViewName("redirect:/m/user/ollehUserAgreement.kt?urlcd=/m/payment/result.kt");
				return modelAndView;
				
			// 3. 본인 인증 여부 체크
			} else if(status == SDPConstants.REQ_SELF_CERT) {
				//modelAndView.setViewName("mobile/premium/premiumMyCert");
				modelAndView.setViewName("redirect:/m/premium/premiumMyCert.kt?urlcd=/m/payment/result.kt");
				return modelAndView;
	 ...
	 * @return ModelAndView modelAndView : ModelAndView 객체
	 */
	@RequestMapping(value = "/m/payment/requestSmsOtp.kt")
	 ...
	 * @return ModelAndView modelAndView : ModelAndView 객체
	 */
	@RequestMapping(value = "/m/payment/approveSmsOtp.kt")
