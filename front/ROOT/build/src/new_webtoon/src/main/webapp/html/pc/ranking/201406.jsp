<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
			<div class="ranking_best_list">
				<div class="topArea">
					<div class="mTit"><img src="/images/pc/tit_month_rank6.gif" alt="6월 월간 랭킹" /></div>
					<!-- <div class="mCalc">
						<a href="monthList.kt?select_month=201405" class="month_left">이전달</a>
						<span class="month_txt">2014년 6월</span>
						<div style="display: inline-block; height:21px; line-height:300px; margin:0 10px; overflow: hidden; vertical-align: middle;width: 21px;"></div>
					</div> -->
					<div class="mSel">
						<select name="select_month" id="select_month">
							<option value="201407">2014년 7월</option>
							<option value="201406" selected="selected">2014년 6월</option>
							<option value="201405">2014년 5월</option>
							<option value="201404">2014년 4월</option>
						</select>
					</div>
				</div>
				...
				<div class="listArea listArea1st">
					<a href="http://webtoon.olleh.com/main/times_list.kt?webtoonSeq=40">
						...
						<img src="/images/pc/temp/thumb_01_140703.jpg" alt="썸툰 시즌2" class="rank_thumb" />
						...
						<div class="rank_cont">
							...
							<div class="cont_wr">
								<div class="cont">
									...
									<span class="cont_r">부러우면 지는거다! 매번 지면서 보는 썸툰~ 정주행 해도 안~~생겨요~~</span>
								</div>
							</div>
						</div>
					</a>
				...
				<div class="listArea listAreaTop">
					<a href="http://webtoon.olleh.com/main/times_list.kt?webtoonSeq=11">
						...
						<img src="/images/pc/temp/thumb_02_140703.jpg" alt="개천고" class="rank_thumb" />
						<div class="bg_thumb"></div>
						<div class="rank_cont">
							<div class="top">
							...
							<div class="cont_wr">
								<div class="cont">
									<span class="cont_l">한줄평</span>
									<span class="cont_r">개천의 용이 될 것인가, 이무기가 될 것인가?</span>
								</div>
							</div>
						</div>
					</a>
				...
				<div class="listArea listAreaTop">
					<a href="http://webtoon.olleh.com/main/times_list.kt?webtoonSeq=28">
						<div class="rank_num">
							...
							<span class="upDown"><span class="ic ic_up"></span>3</span>
						</div>
						<img src="/images/pc/temp/thumb_03_140703.jpg" alt="수상한 그녀의 밥상" class="rank_thumb" />
						<div class="bg_thumb"></div>
						<div class="rank_cont">
							<div class="top">
							...
							<div class="cont_wr">
								<div class="cont">
									<span class="cont_l">한줄평</span>
									<span class="cont_r">수상한 그녀를 둘러싼 엇갈리는 삼각관계</span>
								</div>
							</div>
						</div>
					</a>
				...
				<div class="listArea">
					<a href="http://webtoon.olleh.com/main/times_list.kt?webtoonSeq=15">
						...
						<img src="/images/pc/temp/thumb_04_140703.jpg" alt="냄새를 보는 소녀" class="rank_thumb" />
						<div class="bg_thumb"></div>
						<div class="rank_cont">
							<div class="top">
				...
				<div class="listArea">
					<a href="http://webtoon.olleh.com/main/times_list.kt?webtoonSeq=38">
						<div class="rank_num">
							...
							<span class="upDown"><span class="ic ic_down"></span>3</span>
						</div>
						<img src="/images/pc/temp/thumb_05_140703.jpg" alt="샌드위치를 먹다" class="rank_thumb" />
						<div class="bg_thumb"></div>
						<div class="rank_cont">
							<div class="top">
				...
				<div class="listArea">
					<a href="http://webtoon.olleh.com/main/times_list.kt?webtoonSeq=59">
						<div class="rank_num">
							...
							<span class="upDown"><span class="ic ic_up"></span>2</span>
						</div>
						<img src="/images/pc/temp/thumb_06_140703.jpg" alt="악마도 의무교육 받습니다" class="rank_thumb" />
						<div class="bg_thumb"></div>
						<div class="rank_cont">
							<div class="top">
				...
				<div class="listArea">
					<a href="http://webtoon.olleh.com/main/times_list.kt?webtoonSeq=3">
						...
						<img src="/images/pc/temp/thumb_07_140703.jpg" alt="병맛극장" class="rank_thumb" />
						<div class="bg_thumb"></div>
						<div class="rank_cont">
							<div class="top">
				...
				<div class="listArea">
					<a href="http://webtoon.olleh.com/main/times_list.kt?webtoonSeq=55">
						...
						<img src="/images/pc/temp/thumb_08_140703.jpg" alt="하루달콤 하루쌉싸름" class="rank_thumb" />
						<div class="bg_thumb"></div>
						<div class="rank_cont">
							<div class="top">
				...
				<div class="listArea">
					<a href="http://webtoon.olleh.com/main/times_list.kt?webtoonSeq=46">
						...
						<img src="/images/pc/temp/thumb_09_140703.jpg" alt="냠냠이" class="rank_thumb" />
						<div class="bg_thumb"></div>
						<div class="rank_cont">
							<div class="top">
				...
				<!--10th-->
				<div class="listArea">
					<a href="http://webtoon.olleh.com/toon/timesList.kt?webtoonseq=20">
						<div class="rank_num">
							<span class="num num10">10</span><!--순위-->
							<span class="upDown"><span class="ic ic_new">신규</span></span>
						</div>
						<img src="/images/pc/temp/thumb_10_140703.jpg" alt="아만자" class="rank_thumb" />
						<div class="bg_thumb"></div>
						<div class="rank_cont">
							<div class="top">
								<span class="name">붉은 여우</span>
							</div>
							<div class="etc">
								<span class="author">하마</span>
								<span class="date">연재일 : 수</span>
							</div>
						</div>
					</a>
				</div>
